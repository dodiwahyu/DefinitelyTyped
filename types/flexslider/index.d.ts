...
declare namespace FlexSlider {
    ...
    interface Options {
        ...
        /**
         * {NEW} Selector: Mirror the actions performed on this slider with another
         * slider. Use with care.
         */
        sync?: string;
        /**
         * {NEW} Selector: Internal property exposed for turning the slider into a
        ...
        // Carousel Options
        /**
         * {NEW} Integer: Box-model width of individual carousel items, including
        ...
        itemMargin?: number;
        /**
         * {NEW} Integer: Minimum number of carousel items that should be visible.
         * Items will resize fluidly when below this.
         * @default 1
         */
        minItems?: number;
        /**
         * {NEW} Integer: Maxmimum number of carousel items that should be visible.
         * Items will resize fluidly when above this limit.
         * @default 0
         */
        maxItems?: number;
        /**
         * {NEW} Integer: Number of carousel items that should move on animation. If
